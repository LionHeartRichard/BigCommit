...
public class TestMain {
	...
	private static void codecTest() {
		...
		HuffmanEncoderStream huffmanEncoderStream = new HuffmanEncoderStream(new EncodingModelRefreshing(),
		...
		HuffmanDecoderStream huffmanDecoderStream = new HuffmanDecoderStream(new EncodingModelRefreshing(),
				byteArrayOutputStream);
		try {
	...
	private static void fileCodecTest() {
		try {
			String content = new String(
					Files.readAllBytes(Paths.get(".\\src\\ru\\arhiser\\huffman\\voyna-i-mir-tom-1.txt")));
			BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(
					new FileOutputStream(".\\src\\ru\\arhiser\\huffman_adapt\\digital\\voyna-i-mir-tom-1.huf"));
			HuffmanEncoderStream huffmanEncoderStream = new HuffmanEncoderStream(new EncodingModelRefreshing(),
					bufferedOutputStream);
			huffmanEncoderStream.write(content.getBytes(StandardCharsets.UTF_8));
			huffmanEncoderStream.close();

			BufferedOutputStream decodeOutput = new BufferedOutputStream(
					new FileOutputStream(".\\src\\ru\\arhiser\\huffman_adapt\\digital\\decoded.txt"));
			HuffmanDecoderStream huffmanDecoderStream = new HuffmanDecoderStream(new EncodingModelRefreshing(),
					decodeOutput);
			BufferedInputStream inputStream = new BufferedInputStream(
					new FileInputStream(".\\src\\ru\\arhiser\\huffman_adapt\\digital\\voyna-i-mir-tom-1.huf"));
	...
	private static void fileCodecDigitalTest() {
		try {
			...
			BufferedInputStream bis = new BufferedInputStream(
					new FileInputStream(".\\src\\ru\\arhiser\\huffman\\voyna-i-mir-tom-1.txt"));
