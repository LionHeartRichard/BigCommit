...
/*
 * Учитывая массив строк words и ширину maxWidth, отформатируйте текст так, чтобы каждая строка
 * содержала ровно maxWidth символы и была полностью (влево и вправо) выровнена. Вам следует 
